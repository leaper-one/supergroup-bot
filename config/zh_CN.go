...
var zh_CN_Text = text{
	...
	OpenSpeakJoinMsg:    "📢 本社群已开启会员发言，想发言参与讨论请到会员中心付费购买或授权免费领取会员资格。\n\n非会员可以接收所有聊天消息但是不能参与聊天，你所有的发言只有管理员能看到，可以给管理员留言咨询问题。",
