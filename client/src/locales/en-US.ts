...
const _i18n = {
  ...
  member: {
    ...
    center: "Membership",
    level0: "Primary position membership",
    ...
    level1Desc: "1-Receive all chat messages,1-Participate in grabbing Lucky Coin,1-Leave messages to the admins,0-Send chat messages",
    level2: "Primary Membership",
    level2Auth: "Primary position membership",
    level2Pay: "Primary paid membership",
    level2Desc: "1-Receive all chat messages,1-Participate in grabbing Lucky Coin,1-Leave messages to the admins,1-Send chat messages,1-Send 10 messages per minute,0-Send various type of messages include images and videos",
