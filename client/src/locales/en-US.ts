...
const _i18n = {
  ...
  member: {
    ...
    levelPay: "Pay {payAmount} {symbol} to get 1-year membership, or free to join if you give access to read your wallet amounts and always keep your balance is equal or greater than {amount} {symbol} .",
