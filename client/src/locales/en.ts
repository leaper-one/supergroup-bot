...
const _i18n = {
  ...
  join: {
    ...
    modal: {
      ...
      sharesCheck2: "The balance check include Mixin wallet, Exin 流动池， 活期宝， 省心投 and Fox's Defi products such as flex-term, fixed-term, regular Invest, and Node.",

      appoint: 'Subscribe successfully',
      appointDesc: 'Thanks for subscribing! Please add this bot as a contact and turn on notification permission to receive the Airdrop qualification push alert.',
      appointBtn: 'Add to contact',
      appointTips: 'Tap the top right corner to close the bot, then wait for notification',
      receive: 'Airdrops',
      receiveDesc: 'Congratulations on getting MobileCoin Airdrop! Thank you so much for being so supportive of MobileCoin, and welcome to claim the Airdrop and join the group.',
      receiveBtn: 'Claim MOB Airdrop',
      receivedDesc: 'This is the Airdrop for participating {comment}！ Thanks for your support of MobileCoin and Mixin!',
  ...
  claim: {
    ...
    voucher: {
      ...
      status: {
        ...
        '3': 'Voucher code expired',
        '9': 'Successfully redeemed!',
      },
  ...
  guess: {
    ...
    todyDesc: "Today {time} UTC+8 {coin} token price is ${usd} (price collected from Coingecko.com) please guess tomorrow's {time} UTC+8:",
