...
const _i18n = {
  ...
  member: {
    ...
    level2Auth: "初级持仓会员",
    level2Pay: "初级付费会员",
    level2Desc: "1-接受全部聊天记录,1-参与抢红包,1-给管理员留言,1-发消息参与聊天,1-每分钟发 10 条消息,0-发图片、视频等多种消息",
    level2Sub: "可发文字等 3 种类型消息，每分钟可发 5～10 条消息。",
    level5: "资深会员",
    level5Auth: "资深持仓会员",
    level5Pay: "资深付费会员",
    level5Desc: "1-接受全部聊天记录,1-参与抢红包,1-给管理员留言,1-发消息参与聊天,1-每分钟发 20 条消息,1-发图片、视频等多种消息",
