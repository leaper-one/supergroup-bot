...
const _i18n = {
  ...
  setting: {
    title: '設定',
    accept: 'チャットメッセージの受信',
    acceptTips: 'チャットの受信を停止しても、重要なプロジェクトのアナウンスはすべて掲載されます。',
    ...
    cancel: {
      title: 'チャットの受付の停止',
      content: 'チャットの受付を停止しても、重要なプロジェクトのアナウンスはすべて掲載されます。以下の数字を順番に入力して、操作を確定してください。',
    },
    exited: 'コミュニティから退会しました',
    exitedDesc: 'コミュニティから退会しました。右上をクリックしてコミュニティページを閉じてください。',
  },
  ...
  member: {
    ...
    center: '会員ランク',
    level0: '通貨保有会員',
    authReject: 'チャットへのメッセージ送信',
    authDesc: '全てのチャットの受信\n投げ銭の受取\nチャットへのメッセージ送信\n1分間に最大{max}メッセージを送信可能\nテキストなど{count}種類のメッセージを送信することができます',
    level0Desc: '1-全てのチャットの受信,1-投げ銭の受取,1-チャットへのメッセージ送信,1-1分間に最大20メッセージを送信可能,1-ダイヤモンド会員は写真、ビデオ、他の種類のメッセージを送ることができます。',
    level0Sub:
      '定期的なウォレットチェックの際のウォレット内資産に応じて、会費無料で、通貨保有ダイヤモンド会員または通貨保有ダイヤモンド会員に自動登録されます。ウォレット残高が{lamount} {symbol}以上の場合は通貨保有ダイヤモンド会員、{hamount} {symbol}以上の場合は通貨保有ダイヤモンド会員になります。',
    level1: 'レギュラー会員',
    level1Desc: '1-全てのチャットの受信,1-投げ銭の受取,0-チャットへのメッセージ送信',
    level2: 'ダイヤモンド会員',
    level2Auth: '通貨保有ダイヤモンド会員',
    level2Pay: '有料ダイヤモンド会員',
    level2Desc: '1-全てのチャットの受信,1-投げ銭の受取,1-チャットへのメッセージ送信,1-1分間に最大10メッセージを送信可能,1-テキストなど3種類のメッセージを送信することができます。',
    level2Sub: 'テキストを含む3種類のメッセージを、1分間最大10通送信できます。',
    level5: 'ダイヤモンド会員',
    level5Auth: '通貨保有ダイヤモンド会員',
    level5Pay: '有料ダイヤモンド会員',
    level5Desc:
    ...
    levelPay: '{amount} {symbol}を支払い、1年間{level}となります。テキストなど{category}種類のメッセージを送信でき、1分間に{min}～{max}通のメッセージの送信が可能です。',
    checkPaid: '支払確認',
    authTips:
      "ウォレット内資産による資産保有会員は、定期的に資産の確認が行われます。詳細な手順については、以下のドキュメントをご覧ください。：<a href='https://note.com/linksbtc/n/n9606db924398'>https://note.com/linksbtc/n/n9606db924398</a>",
    forFree: '無料で利用可能',
    forPay: '{amount} {symbol}を支払う',

    cancel: '会員の解除',
    cancelDesc: '会員の解除を行うと会員資格を失い、コミュニティシステムはあなたの資産情報を読み取ることができなくなります。',

    expire: '会員資格は{date}まで有効です。期限末までに更新してください。',
    failed: '会員ランクの有効化に失敗しました。',
    failedDesc: 'あなたは会員ランク有効化の要件を満たしていません。資産の読み取りが許可されていることを確認してください。',
  },
  advance: {
    title: '詳細設定',
    mute: 'グループ全体をミュート',
  ...
  join: {
    ...
    modal: {
      ...
      sharesCheck1: '以上',
      sharesCheck2: '会員ランク情報の検出は、Linksウォレットに対応しています。',

      appoint: '予約が完了しました',
      appointDesc: 'ご予約ありがとうございます。 エアドロップの通知を受け取るには、このミニアプリの通知をオンにしてください。',
      appointBtn: '連絡先の追加',
      appointTips: '右上をタップして通知をオフにする',
      receive: 'エアドロップ報酬',
      receiveDesc: 'MobileCoinエアドロップへの参加資格の取得、おめでとうございます。 MobileCoinのサポートに感謝し、エアドロップを受け取り、グループに参加することを歓迎します。',
      receiveBtn: 'MOBを受け取る',
      receivedDesc: '{comment}に参加された方へのエアドロップ報酬です！いつもMobileCoinとLinksを応援して頂き、ありがとうございます。',
      receivedBtn: '受取済み',
    },
  ...
  news: {
    ...
    sendLive: '配信の追加',
    live: '配信',
    confirmStart: '配信を開始しますか？',
    confirmEnd: '配信を終了しますか',
    prompt: '配信のアドレスを入力してください。',
    form: {
      img: '配信イメージ',
      category: '配信カテゴリー',
  ...
  reward: {
    ...
    less: '最低額は1ドルです。',
    success: 'リワードに成功しました。',
    isLiving: '配信中はリワードを行えません。配信終了後に実行ください。',
  },
  ...
  claim: {
    ...
    checkin: {
      ...
      checked: '参加済み',
      count: '今週 {count}/7',
      describe: '毎日ログインにつき５エナジー、週に5日以上ログインで別途２５エナジー獲得！',
    },
    voucher: {
  ...
  guess: {
    ...
    todyDesc: '今日 {time} UTC+8 {coin} の価格は ${usd}です(参照:Coingecko.com)。明日の{time} UTC+8 の価格を予想してください:',
