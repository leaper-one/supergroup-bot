...
export const NumberConfirm = (props: INumberConfrimProps) => {
  ...
  return (
    <Modal visible={props.show} popup onClose={() => props.setShow(false)} animationType="slide-up">
...
export const SliderConfirm = (props: INumberConfrimProps) => {
  return (
    <Modal visible={props.show} popup onClose={() => props.setShow(false)} animationType="slide-up">
      <div className={styles.dialog}>
        <img className={styles.close} src={require('@/assets/img/svg/closeBtn.svg')} alt="" onClick={() => props.setShow(false)} />
        <div className={styles.title}>{props.title}</div>
