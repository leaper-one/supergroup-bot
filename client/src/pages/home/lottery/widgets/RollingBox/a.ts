...
//     for (
//       var i = lottery._count() - this.options.height + 1,
//         j = 0,
//         len = this.options.width + this.options.height - 2;
//       i >= len;
//       --i, ++j
//     ) {
//       this.container
//         .find(".group:last .unit:eq(" + j + ")")
//         .not("[data-index]")
//         .attr("data-index", i)
//     }
...
//       this.container
//         .find(".group:eq(" + i + ") .unit:first")
//         .not("[data-index]")
//         .attr("data-index", lottery._count() - i)
//       this.container
//         .find(".group:eq(" + i + ") .unit:last")
//         .not("[data-index]")
//         .attr("data-index", this.options.width + i - 1)
//     }
//     this._enable()
//   },
...
//     var _this = this
//     if (
//       _this.options.speed > _this.options.downMax &&
//       _this.options.target == _this._index()
//     ) {
//       _this._stop()
//     } else {
...
//     } else {
//       this.options.target = parseInt(
//         (parseInt(Math.random() * 10) * this._count()) / 10,
//       )
