...
export default function () {
  ...
  return (
    <div>
      {mintData ? (
        <div className={styles.intro}>
          ...
          <div className={styles.btn}>
            <div className={styles.btn_item} onClick={() => setContinueModal(true)}>
              {$t('mint.join')}
            </div>
            <div
      ...
      {showContinueModal && (
        <div className={styles.mask} onClick={() => setContinueModal(false)}>
          <div className={styles.mask_content} onClick={(e) => e.stopPropagation()}>
            ...
            <div className={styles.mask_btn}>
              ...
              <div className={styles.btn_item} onClick={() => setContinueModal(false)}>
                {$t('mint.close')}
              </div>
            </div>
          </div>
