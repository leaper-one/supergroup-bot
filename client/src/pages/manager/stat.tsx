  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.charts}>
        ...
        <Select showModal={showUserModal} setShowModal={setShowUserModal} mode={userMode} setMode={setUserMode} $t={$t} initCharts={initCharts} chart="user" />
      </div>
      <div className={styles.charts}>
        <div id="message" style={{ width: '100%', height: '100%' }} />
        <Select showModal={showMessageModal} setShowModal={setShowMessageModal} mode={messageMode} setMode={setMessageMode} $t={$t} initCharts={initCharts} chart="message" />
      </div>
    </div>
  );
}
