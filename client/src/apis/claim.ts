...
// 获取能量记录
export const ApiGetClaimRecord = (page = 1, defaultData: RecordByDate[]): Promise<RecordByDateResponse> => apis.get('/power/record', { page }).then(transfromRecords(defaultData));
...
// 获取抽奖奖励
export const ApiGetLotteryReward = (trace_id: string) => apis.post('/lottery/reward', { trace_id });
